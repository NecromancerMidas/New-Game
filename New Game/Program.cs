...
namespace New_Game
{
    ...
    class MainGame
    {
        ...
        public static void Main()
        {
            ...
            Draw.Box(Staff.DrawWeaponStats());
            Draw.Box(Dagger.DrawWeaponStats());
            Draw.Box(Sword.DrawWeaponStats());
            Draw.Box(Plate.DrawArmorStats());
            Draw.Box(Leather.DrawArmorStats());
            Draw.Box(Robe.DrawArmorStats());
